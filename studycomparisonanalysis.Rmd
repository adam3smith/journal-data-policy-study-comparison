...
# Overlapping journals: Identify the 127 journals in Crosas et al 2018 that are also in one or more of five previous studies (the sixth study, H̦ffler 2017, is exluded because we could not obtain journal-level data)
...
codebook_data <- within(codebook_data, {
  ...
  wording(zenkmoltgenhaspolicy) <- "Does Zenk-M̦ltgen, W., & Lepthien, G. 2014 report that the journal has a data policy?"
